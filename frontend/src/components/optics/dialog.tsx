...
function DialogViewport(
	props: React.ComponentPropsWithoutRef<typeof DialogPrimitive.Viewport>,
) {
...
export type DialogPopupProps = React.ComponentPropsWithoutRef<typeof DialogPrimitive.Popup> & {
